...
if (!Auth::check()) {
    ...
    echo json_encode(['success' => false, 'message' => 'Session expired.', 'redirect' => APP_URL . '/user-junkshop/login.php']);
    exit;
}
...
echo json_encode(['success' => false, 'message' => 'This payment action is not available for your account.']);
